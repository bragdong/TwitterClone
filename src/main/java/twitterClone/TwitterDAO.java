...
public class TwitterDAO {
	...
	public  int initDB(){
		...
		//String createLikersTableSql="CREATE TABLE `Likers` ( `like_id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, `tweet_id` INTEGER, `user_id` INTEGER, FOREIGN KEY(`tweet_id`) REFERENCES Tweets(tweet_id), FOREIGN KEY(`user_id`) REFERENCES User(user_id) )";
